...
function ProductView() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const filterResponse = await axios.get('https://18ebbuf8l8.execute-api.ap-south-1.amazonaws.com/demo/api/v3/user/marketplace/filter-data');
      setSegments(filterResponse.data.data.segments);
    } catch (error) {
...
<section className="">
        ...
        <div className="collapse card d-lg-block mb-5" id="navbarSupportedContent">
          <div className="accordion" id="accordionPanelsStayOpenExample">
            ...
            <div >
              <h6 id="headingTwo">
                <span
                        className=" text-dark bg-transparent Develope mt-5 " style={{marginLeft:'22px'}}
                        type="button"
                        data-mdb-toggle="collapse"
                ...
                <div className="accordion-body">
                  <div>
                    ...
                    <div className="form-check checkBoxes mb-3">
                      <input className="form-check-input rounded-circle" type="checkbox" value="" id="flexCheckChecked1" checked={mercedesChecked}
                          onChange={() => setMercedesChecked(!mercedesChecked)} />
                      <label className="form-check-label" for="flexCheckChecked1">All
</label>
                      <span className="badge badge-secondary float-end">120</span>
                    </div>
                    
                    <div className="form-check checkBoxes mb-3">
                      <input className="form-check-input rounded-circle" type="checkbox" value="" id="flexCheckChecked2"  checked={toyotaChecked}
                          onChange={() => setToyotaChecked(!toyotaChecked)} />
                      <label className="form-check-label" for="flexCheckChecked2">Lorem Ipsum</label>
                      <span className="badge badge-secondary float-end">15</span>
                    </div>
                    
                    <div className="form-check checkBoxes mb-3">
                      <input className="form-check-input rounded-circle" type="checkbox" value="" id="flexCheckChecked3" checked={mitsubishiChecked}
                          onChange={() => setMitsubishiChecked(!mitsubishiChecked)} />
                      <label className="form-check-label" for="flexCheckChecked3">Lorem Ipsum</label>
                      <span className="badge badge-secondary float-end">35</span>
                    </div>
                    
                    <div className="form-check checkBoxes mb-3">
                      <input className="form-check-input rounded-circle" type="checkbox" value="" id="flexCheckChecked4" checked={nissanChecked}
                          onChange={() => setNissanChecked(!nissanChecked)} />
                      <label className="form-check-label" for="flexCheckChecked4">Lorem Ipsum</label>
            ...
            <div >
              <h6  id="headingThree">
                <span
                        className="text-dark bg-transparent mt-5 " style={{marginLeft:'-225px'}}
                        type="button"
                        data-mdb-toggle="collapse"
      ...
      <div>
        <div className="form-check checkBoxes mb-3">
          <input
            ...
            onChange={() => setMercedesChecked(!mercedesChecked)}
          />
          <label className="form-check-label" htmlFor="flexCheckCheckedSeparate1">
            All
          </label>
          <span className="badge badge-secondary float-end">120</span>
        </div>
  ...
  <input
    ...
    onChange={() => handleApplicationTypeChange('1')}
  />
  <label className="form-check-label" htmlFor="flexCheckCheckedSeparate2">
